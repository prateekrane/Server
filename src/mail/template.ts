...
export const generateTemplate = (options: Options) => {
  ...
  return `
    ...
    <div style="max-width: 195px;"><img alt="your logo" src=${logo} style="display: block; height: auto; border: 0; width: 100%;" title="your logo" width="195"/></div>
    </div>
    </td>
    </tr>
    </table>
    ...
    <td class="pad">
    <div align="center" class="alignment" style="line-height:10px">
    <div class="fullWidth" style="max-width: 357.5px;"><img alt="Forgot your password?" src=${banner} style="display: block; height: auto; border: 0; width: 100%;" title="Forgot your password?" width="357.5"/></div>
    </div>
    </td>
    </tr>
    </table>
    ...
    <h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 28px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 33.6px;"><strong>${title}</strong></h1>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0; word-break: break-word;"><span style="color:#aa67cf;">${message}</span></p>
    ...
    <p style="margin: 0; word-break: break-word;"><span style="color:#8412c0;">This is your VERIFICATION OTP....</span></p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0; word-break: break-word;"><span style="color:#aa67cf;"><span>If you didn't request to get your verification code, </span><span>you don't have to do anything. So that's easy.</span></span></p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0; word-break: break-word;"><span style="color:#8a3b8f;"><img alt="your logo" src=${logo} style="display: block; justifyContent:"center"; alignItem:"center";height: 50px; border: 0; width: 100px;" title="your logo" width="195"/></span></p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;"><a href="http://designedwithbeefree.com/" style="text-decoration: none;" target="_blank">
